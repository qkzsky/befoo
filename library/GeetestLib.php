...
class GeetestLib
{
     ...
     * @return bool
     */
    public function validate($status, $challenge, $validate, $seccode, $user_id = null)
    {
        if ($status)
        {
            if (!$this->sucess_validate($challenge, $validate, $seccode, $user_id))
            {
                return false;
            }
        }
        ...
        {
            if (!$this->fail_validate($challenge, $validate))
            {
                return false;
            }
        }
