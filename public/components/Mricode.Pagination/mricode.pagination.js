...
(function (factory) {
    ...
    Page.prototype = {
        ...
        renderPagination: function () {
            ...
            if (lastPageNum > 1) this.$page.show(); else this.$page.hide();
            if (this.options.showPageSizes && lastPageNum > 1) this.$size.show(); else this.$size.hide();
            if (this.options.showJump && lastPageNum > 1) this.$jump.show(); else this.$jump.hide();
